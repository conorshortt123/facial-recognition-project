...
Having been allowed to explore different technologies from the very start of the project we feel it has given each of us, a taste of different technologies we would have never come across, if there was a set technology to be used. 
